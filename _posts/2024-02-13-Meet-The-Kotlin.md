...
ppt와 사내 위키에 Kotlin 소개 및 장점 등을 정리하여 발표를 진행하였고 같이 포스팅하고 있는 성현님과 주영님 그리고 Kotlin에 관심을 가진 팀원들과 함께 스터디도 진행했습니다.      
퇴근 후, 주말에 개인 시간을 조금씩 사용하여 기존 Java 프로젝트에 Kotlin을 추가하여 신규 기능은 Kotlin으로 개발하는 방법,    
기존 Java 코드를 Kotlin으로 마이그레이션 하는 기술 도입에 리스크가 낮고 안정성이 높은 걸 팀원들에게 보여주면서 Kotlin을 도입하게 되었습니다.
