...
## 소개 : OJT란?
누구든 이전과 다른 새로운 환경에서 시작할 때가 있습니다. 바뀐 환경에서 처음부터 완벽하게 적응한다면 이상적이지만 낯선 곳에서 출발하여 궤도에 이르기까지 시간이 필요합니다. 따라서 회사에선 채용 후 바로 실무에 투입하는 것이 아닌 구성원의 이해와 적응을 돕도록 OJT를 실시하고 있습니다. 
