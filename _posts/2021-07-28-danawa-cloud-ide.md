...
- Goorm IDE 초기 화면입니다. 접속한 유저의 플랜 정보와 사용중인 컨테이너 및 이미지에 대한 정보를 볼 수 있습니다. 이 곳에 새로운 컨테이너를 생성하는 버튼이 존재합니다.

- 신규 컨테이너를 생성하는 화면입니다. 이 화면에서 유저가 컨테이너 이름, 설명, 지역, 공개범위, 템플릿 등을 작성하고 소프트웨어 스택을 선택해서 사용할 수 있습니다.
