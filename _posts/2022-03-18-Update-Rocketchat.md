...
Rocket.Chat 은 HipChat, Slack 형태의 중소규모 그룹을 위한 오픈소스 메신저 서버/클라이언트 프로그램입니다. 
실시간 채팅을 할 수 있고, 음성과 화상채팅도 가능합니다. 다양한 서버 OS를 지원하고 있습니다.

## 다나와에서는..

다나와 Devops/검색 팀에서는 메신저로 로켓챗 서버를 구축해서 사용중입니다.
진행했던 기존 이슈들에 대한 대화내역과 이미지, URL 등 저장을 위해 메시지들을 저장하고 있습니다.
